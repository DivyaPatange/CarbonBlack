  ...
  <div class="mdc-layout-grid__inner mt-5">
    ...
    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
      <div class="mdc-card p-0">
        ...
        <form action="{{ route('question.trueorfalse.store', $test->id) }}" enctype="multipart/form-data" method="post">
          <div class="mdc-card">
          @csrf
            <div class="template-demo">
              <div class="mdc-layout-grid__inner">
                ...
                <input type="hidden" name="que_type" value="trueorfalse">
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                <div class="mdc-form-field mr-3">
                Correct Answer:-
                </div>
                    <div class="mdc-form-field mr-3">
                        <div class="mdc-checkbox mdc-checkbox--success">
                            <input type="radio" name="correct_ans" value="true">
                            <label for="basic-disabled-checkbox" id="basic-disabled-checkbox-label">True</label>
                        </div>
                    </div>
                    <div class="mdc-form-field">
                        <div class="mdc-checkbox mdc-checkbox--success">
                            <input type="radio" name="correct_ans" value="false">
