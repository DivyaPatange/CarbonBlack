...
<html lang="en">
<head>
  <title>CARBON BLACK EDUCATION | Create Administrator</title>
  <meta charset="utf-8">
      ...
      <div class="card-body">
        <div class="row py-5">
          <div class="col-md-12 box py-3">
            ...
            <form method="POST" action="{{ route('adminReg.store') }}" enctype="multipart/form-data">
				@csrf
				<div class="row">
				...
				<div class="row">
					<div class="col-12 text-center">
                		...
                		<button class="bnkgothl" type="submit" style="display:inline-block">SIGN UP</button>
